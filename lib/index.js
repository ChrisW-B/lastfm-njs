...
LastFM.prototype.auth_getMobileSession = callback => {
	var self = this;
	var qs = {
...
//album methods
LastFM.prototype.album_addTags = opt => {
	var qs = opt || {};
...
LastFM.prototype.album_getInfo = opt => {
	var qs = opt || {};
...
LastFM.prototype.album_getTags = opt => {
	var qs = opt || {};
	if ((qs.artist === '' || qs.artist === undefined ||
			qs.album === '' || qs.album === undefined) &&
		(qs.mbid === '' || qs.mbid === undefined)) {
...
LastFM.prototype.album_getTopTags = opt => {
	var qs = opt || {};
	if ((qs.artist === '' || qs.artist === undefined ||
			qs.album === '' || qs.album === undefined) &&
		(qs.mbid === '' || qs.mbid === undefined)) {
...
LastFM.prototype.album_removeTag = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined ||
		qs.album === '' || qs.album === undefined ||
...
LastFM.prototype.album_search = opt => {
	var qs = opt || {};
...
//Artist methods
LastFM.prototype.artist_addTags = opt => {
	var qs = opt || {};
...
LastFM.prototype.artist_getCorrection = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined) {
...
LastFM.prototype.artist_getInfo = opt => {
	var qs = opt || {};
...
LastFM.prototype.artist_getSimilar = opt => {
	var qs = opt || {};
	if ((qs.artist === '' || qs.artist === undefined) && (qs.mbid === '' || qs.mbid === undefined)) {
		return this._sendErr('Missing both artist and mbid', qs.callback);
	}
...
LastFM.prototype.artist_getTags = opt => {
	var qs = opt || {};
	if (((qs.artist === '' || qs.artist === undefined) && (qs.mbid === '' || qs.mbid === undefined)) ||
...
LastFM.prototype.artist_getTopAlbums = opt => {
	var qs = opt || {};
	if ((qs.artist === '' || qs.artist === undefined) && (qs.mbid === '' || qs.mbid === undefined)) {
		return this._sendErr('Missing both artist and mbid', qs.callback);
	}
...
LastFM.prototype.artist_getTopTags = opt => {
	var qs = opt || {};
	if ((qs.artist === '' || qs.artist === undefined) && (qs.mbid === '' || qs.mbid === undefined)) {
		return this._sendErr('Missing both artist and mbid', qs.callback);
	}
...
LastFM.prototype.artist_getTopTracks = opt => {
	var qs = opt || {};
	if ((qs.artist === '' || qs.artist === undefined) && (qs.mbid === '' || qs.mbid === undefined)) {
		return this._sendErr('Missing both artist and mbid', qs.callback);
	}
...
LastFM.prototype.artist_removeTag = opt => {
	var qs = opt || {};
...
LastFM.prototype.artist_search = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined) {
...
//Chart Methods
LastFM.prototype.chart_getTopArtists = opt => {
	var qs = opt || {};
	merge(qs, {
...
LastFM.prototype.chart_getTopTags = opt => {
	var qs = opt || {};
	merge(qs, {
...
LastFM.prototype.chart_getTopTracks = opt => {
	var qs = opt || {};
	merge(qs, {
...
//Geo Methods
LastFM.prototype.geo_getTopArtists = opt => {
	var qs = opt || {};
...
LastFM.prototype.geo_getTopTracks = opt => {
	var qs = opt || {};
	if (qs.country === '' || qs.country === undefined) {
		return this._sendErr('Missing country', qs.callback);
	}
...
//Library Methods
LastFM.prototype.library_getArtists = opt => {
	var qs = opt || {};
...
//Tag Methods
LastFM.prototype.tag_getInfo = opt => {
	var qs = opt || {};
...
LastFM.prototype.tag_getSimilar = opt => {
	var qs = opt || {};
	if (qs.tag === '' || qs.tag === undefined) {
		return this._sendErr('No tag given', qs.callback);
	}
...
LastFM.prototype.tag_getTopAlbums = opt => {
	var qs = opt || {};
	if (qs.tag === '' || qs.tag === undefined) {
		return this._sendErr('No tag given', qs.callback);
	}
...
LastFM.prototype.tag_getTopArtists = opt => {
	var qs = opt || {};
	if (qs.tag === '' || qs.tag === undefined) {
		return this._sendErr('No tag given', qs.callback);
	}
...
LastFM.prototype.tag_getTopTags = opt => {
	var qs = opt || {};
	qs.method = 'tag.getTopTags';
	return this._get(qs, 'toptags', qs.callback);
};

LastFM.prototype.tag_getTopTracks = opt => {
	var qs = opt || {};
	if (qs.tag === '' || qs.tag === undefined) {
		return this._sendErr('No tag given', qs.callback);
	}
...
LastFM.prototype.tag_getWeeklyChartList = opt => {
	var qs = opt || {};
	if (qs.tag === '' || qs.tag === undefined) {
		return this._sendErr('No tag given', qs.callback);
	}
...
//Track methods
LastFM.prototype.track_addTags = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined ||
...
LastFM.prototype.track_getCorrection = opt => {
	var qs = opt || {};
...
LastFM.prototype.track_getInfo = opt => {
	var qs = opt || {};
	if ((qs.artist === '' || qs.artist === undefined || qs.track === '' || qs.track === undefined) &&
		(qs.mbid === '' || qs.mbid === undefined)) {
		return this._sendErr("Missing required params", qs.callback);
...
LastFM.prototype.track_getSimilar = opt => {
	var qs = opt || {};
	if ((qs.artist === '' || qs.artist === undefined ||
			qs.track === '' || qs.track === undefined) &&
		(qs.mbid === '' || qs.mbid === undefined)) {
...
LastFM.prototype.track_getTags = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined ||
		((qs.artist === '' || qs.artist === undefined ||
				qs.track === '' || qs.track === undefined) &&
...
LastFM.prototype.track_getTopTags = opt => {
	var qs = opt || {};
	if ((qs.artist === '' || qs.artist === undefined ||
			qs.track === '' || qs.track === undefined) &&
		(qs.mbid === '' || qs.mbid === undefined)) {
...
LastFM.prototype.track_love = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined ||
		qs.track === '' || qs.track === undefined) {
		return this._sendErr('Missing required params', qs.callback);
...
LastFM.prototype.track_removeTag = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined ||
		qs.track === '' || qs.track === undefined ||
		qs.tag === '' || qs.tag === undefined) {
...
LastFM.prototype.track_scrobble = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined ||
		qs.track === '' || qs.track === undefined ||
...
LastFM.prototype.track_search = opt => {
	var qs = opt || {};
...
LastFM.prototype.track_unlove = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined ||
		qs.track === '' || qs.track === undefined) {
...
LastFM.prototype.track_updateNowPlaying = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined ||
		qs.track === '' || qs.track === undefined) {
		return this._sendErr('Missing track or artist', qs.callback);
...
//User Methods
LastFM.prototype.user_getArtistTracks = opt => {
	var qs = opt || {};
	if (qs.artist === '' || qs.artist === undefined) {
		return this._sendErr('Missing artist', qs.callback);
	}
...
LastFM.prototype.user_getFriends = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getInfo = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getLovedTracks = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getPersonalTags = opt => {
	var qs = opt || {};
	if (qs.tag === '' || qs.tag === undefined) {
...
LastFM.prototype.user_getRecentTracks = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getTopAlbums = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getTopArtists = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getTopTags = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getTopTracks = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getWeeklyAlbumChart = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getWeeklyArtistChart = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getWeeklyChartList = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
...
LastFM.prototype.user_getWeeklyTrackChart = opt => {
	var qs = opt || {};
	if (qs.user === '' || qs.user === undefined) {
		if (this.username === '' || this.username === undefined) {
			return this._sendErr('Missing user', qs.callback);
