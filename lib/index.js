...
LastFM.prototype.getAlbumTags = function(opt) {
	// opt = {
	// 	artist: artist, //req unless mbid
	// 	album: album, //req unless mbid
...
LastFM.prototype.getAlbumTopTags = function(opt) {
	// opt = {
	// 	artist: artist, //req unless mbid
	// 	album: album, //req unless mbid
	// 	mbid: mbid //opt
...
LastFM.prototype.removeAlbumTags = function(opt) {
	// opt = {
	// 	artist: artist, //req
	// 	album: album, //req
...
LastFM.prototype.findAlbum = function(opt) {
	// opt = {
	// 	album: album, //req
